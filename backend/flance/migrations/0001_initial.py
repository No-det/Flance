    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fields', models.CharField(choices=[('DESKTOP_APP', 'Desktop App Developer'), ('ANDROID_APP', 'Android App Developer'), ('IOS_APP', 'iOS App Developer'), ('WEB_APP', 'Web App Developer'), ('ML', 'Machine Learning'), ('AI', 'Artificial Intelligence')], max_length=50, verbose_name='Fields')),
                ('specialization', models.CharField(choices=[('FED', 'Front End Developer'), ('BED', 'Back End Developer'), ('FSD', 'Full Stack Developer')], max_length=50, verbose_name='Specialization')),
                ('level', models.CharField(choices=[('BEG', 'Beginner'), ('EXP', 'Experienced'), ('PRO', 'Pro')], max_length=20, verbose_name='Level')),
